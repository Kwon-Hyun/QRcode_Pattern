...
def draw(img, imagePoints, projectedPoints):
        corner=tuple(map(int, imagePoints[0].ravel()))
...
for fname in images:
        ...
        x = cv2.putText(image,("X: " + str(camPos[0][0][0])),(10,200),font,4,(255,255,255),2,cv2.LINE_AA)
        y = cv2.putText(image,("Y: " + str(camPos[1][0])),(10,350),font,4,(255,255,255),2,cv2.LINE_AA)
        z = cv2.putText(image,("Z: " + str(camPos[2][0])),(10,500),font,4,(255,255,255),2,cv2.LINE_AA)
        roll = cv2.putText(image,("Roll: " + str(round(roll,2))),(10,950),font,4,(255,255,255),2,cv2.LINE_AA)
        pitch = cv2.putText(image,("Pitch: " + str(round(pitch,2))),(10,800),font,4,(255,255,255),2,cv2.LINE_AA)
        yaw = cv2.putText(image,("Yaw: " + str(round(yaw,2))),(10,650),font,4,(255,255,255),2,cv2.LINE_AA)
